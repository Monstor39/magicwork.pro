...
import { ArrowRight, Check, Utensils, ShoppingBag, Briefcase, Factory, Building2, LineChart } from "lucide-react";
            ...
            {niches.map((n) => {
              ...
              return (
                <button
                  ...
                  className={`group relative inline-flex items-center gap-2 rounded-full border px-4 py-2 text-[13px] font-medium transition-all ${
                    isActive
                      ? "border-accent bg-accent/15 text-text shadow-[0_0_0_1px_rgba(139,92,246,0.4),0_8px_24px_-12px_rgba(139,92,246,0.6)]"
                      : "border-border bg-bg-elevated text-text-muted hover:border-accent/50 hover:text-text"
                  }`}
                >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-accent/15 text-accent ring-1 ring-accent/30">
                ...
                <ul className="grid grid-cols-1 gap-2.5">
                  {active.items.map((item, i) => (
                    <motion.li
                      ...
                      className="flex items-start gap-3 rounded-lg border border-border bg-bg/40 p-3.5"
                    >
