  ...
  return (
    <footer className="border-t border-border bg-bg-elevated/40">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-12 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col gap-2 border-t border-border pt-6 font-mono text-[11px] uppercase tracking-wider text-text-subtle sm:flex-row sm:items-center sm:justify-between">
